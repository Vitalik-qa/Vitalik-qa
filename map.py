...
while check(xpath):
    ...
    time = driver.find_element(By.XPATH, "//*[@class = 'route-list-view__list']/div[" + str(i) + "]/div[1]/div[1]/div[1]")
    # Находим растония маршрута
    distances = driver.find_element(By.XPATH, " //*[@class = 'route-list-view__list']/div[" + str(i) + "]/div[1]/div[1]/div[2]")
    # Выводим
    print("Маршрут №", i, ":", time.text, ",", distances.text)
    # Увеличиваем i на 1
    i += 1
    # Изменяем переменную xpath
    xpath = "//*[@class = 'route-list-view__list']/div[" + str(i) + "]/div[1]/div[1]/div[1]"
