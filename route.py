...
while check(train_xpath):
    ...
    price_xpath = "//*[@id='Page0']/div/div[2]/div[1]/div[3]/div[" + str(j) + "]/div/div/div[1]/div[2]/div[1]/div[" + str(i) + "]/div/div[3]/span[2]"
    ...
    while check(price_xpath):
        ...
        if  price > int((driver.find_element(By.XPATH, price_xpath).text).replace(" ", "")):
            # Сохранения переменных: Названия поезда
            name = driver.find_element(By.XPATH, "//*[@id='Page0']/div/div[2]/div[1]/div[3]/div[" + str(j) + "]/div/div/div[1]/div[1]/div[2]/span[2]").text
            # Тип вагона
            ticket = driver.find_element(By.XPATH, "//*[@id='Page0']/div/div[2]/div[1]/div[3]/div[" + str(j) + "]/div/div/div[1]/div[2]/div[1]/div[" + str(i) + "]/div/div[2]/span").text
            # Цена
            price = driver.find_element(By.XPATH, "//*[@id='Page0']/div/div[2]/div[1]/div[3]/div[" + str(j) + "]/div/div/div[1]/div[2]/div[1]/div[" + str(i) + "]/div/div[3]/span[2]").text
    ...
    i = 1
# Вывод
print("Минимальная цена покупки билета на сайте РЖД у ФПК:", price, "руб.", ticket, "Поезд:", name)
# Ожидание 5 сек.
time.sleep(5)
# Закрываем браузер
driver.close()
